...
class BlinkEyelidNet(nn.Module):
    ...
    def forward(self, image, height, width, pos, heatmap, device, phase='train'):
        ...
        for img, bb, heat in zip(image, bbox, heatall):
            ...
            #print("img_process1: ", img_process)
            datatemp.append(img_process)
            ##print("img_temp: ", img_temp)
            #print("img_process2: ", img_process)
        ...
        feature = inputs[1:10, :, :] # Modify this if time_size changes.
        differ = feature - inputs[0:9, :, :] # modify this if time_size changes.
